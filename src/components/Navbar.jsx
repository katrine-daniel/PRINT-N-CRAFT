...
export default function Navbar({ onOpenEstimate }) {
  ...
  return (
    ...
    <header className={`transition-all duration-200 ${
      isScrolled ? 'bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm py-3' : 'bg-white border-b border-slate-100 py-3.5'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a href="#hero" className="flex items-center space-x-3 group shrink-0">
            ...
            />
            <div>
              <div className="flex items-baseline space-x-1 font-black text-xl tracking-tight leading-none font-sans">
