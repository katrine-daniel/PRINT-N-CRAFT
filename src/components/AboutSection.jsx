      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-brand-cyan transition-all">
              <div className="flex items-start space-x-4">
                <div className="p-3 rounded-xl bg-slate-100 text-brand-cyan shrink-0">
                  <Calendar className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-slate-900">Established in 2012</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-brand-magenta transition-all">
              <div className="flex items-start space-x-4">
                <div className="p-3 rounded-xl bg-slate-100 text-brand-magenta shrink-0">
                  <Zap className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-slate-900">End-to-End Solutions</h3>
                  <p className="text-xs text-slate-600 mt-1 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-slate-900 transition-all">
              <div className="flex items-start space-x-4">
                <div className="p-3 rounded-xl bg-slate-100 text-slate-900 shrink-0">
                  <Users className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-slate-900">Client-Centric Commitment</h3>
                  <p className="text-xs text-slate-600 mt-1 leading-relaxed">
          ...
          <div className="lg:col-span-6">
            <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-clean-md">
              <h3 className="text-xl font-bold text-slate-900 mb-4">Why Choose Print N Craft?</h3>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-3">
                    <div className="w-5 h-5 rounded-full bg-slate-100 text-brand-cyan flex items-center justify-center shrink-0 mt-0.5 font-bold">
